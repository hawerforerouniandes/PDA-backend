...
from pda_propiedades_command.modulos.propiedades.infraestructura.schema.v1.comandos import AsignarTransaccionPayload, \
    ComandoAsignarTransaccion
from pda_propiedades_command.modulos.propiedades.infraestructura.schema.v1.eventos import TransaccionAsignadaPayload, \
    EventoTransaccionAsignada
from pda_propiedades_command.seedwork.infraestructura import utils
import requests
...
class Despachador:
    ...
    def publicar_evento_sagalog(self, evento, topico, name, application, status):
