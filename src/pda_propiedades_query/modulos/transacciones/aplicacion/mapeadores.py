...
from pda_propiedades_query.seedwork.aplicacion.dto import Mapeador as AppMap
from pda_propiedades_query.seedwork.dominio.repositorios import Mapeador as RepMap
