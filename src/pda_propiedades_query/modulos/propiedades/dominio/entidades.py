...
from pda_propiedades_query.modulos.propiedades.dominio.eventos import PropiedadCreada
from pda_propiedades_query.seedwork.dominio.entidades import AgregacionRaiz, Entidad
