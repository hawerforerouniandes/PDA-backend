from pda_propiedades_query.seedwork.aplicacion.servicios import Servicio
...
from pda_propiedades_query.modulos.propiedades.infraestructura.repositorios import RepositorioPropiedades
