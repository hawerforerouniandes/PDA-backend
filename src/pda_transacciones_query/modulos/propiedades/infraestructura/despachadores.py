...
from pda_transacciones_query.modulos.propiedades.infraestructura.schema.v1.comandos import AsignarTransaccionPayload, \
    ComandoAsignarTransaccion
from pda_transacciones_query.modulos.propiedades.infraestructura.schema.v1.eventos import TransaccionAsignadaPayload, \
    EventoTransaccionAsignada
from pda_transacciones_query.seedwork.infraestructura import utils
import requests
