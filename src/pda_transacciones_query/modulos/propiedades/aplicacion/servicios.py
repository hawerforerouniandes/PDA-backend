from pda_transacciones_query.seedwork.aplicacion.servicios import Servicio
...
from pda_transacciones_query.modulos.propiedades.infraestructura.repositorios import RepositorioPropiedades
