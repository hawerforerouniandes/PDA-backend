...
from pda_transacciones_command.seedwork.dominio.entidades import AgregacionRaiz
...
def registrar_unidad_de_trabajo(serialized_obj):
    from pda_transacciones_command.config.uow import UnidadTrabajoSQLAlchemy
    from flask import session
