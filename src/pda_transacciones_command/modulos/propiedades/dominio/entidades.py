...
from pda_transacciones_command.modulos.propiedades.dominio.eventos import PropiedadCreada
from pda_transacciones_command.seedwork.dominio.entidades import AgregacionRaiz, Entidad
