...
def start_pulsar_consumer():
    ...
    consumer = client.subscribe('transaccionespda', consumer_type=pulsar.ConsumerType.Shared, subscription_name='propiedades-transacciones-command', schema=avro_schema)
